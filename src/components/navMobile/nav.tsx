...
const NavMobile = () => {
  ...
  return (
    <div className="fixed w-full h-[48px] sm:h-[72px] top-0 left-0 flex justify-between items-center p-4 z-50 shadow-md backdrop-blur-md border-b border-b-[#bdc3c780] lg:hidden">
      <IoIosSearch
